-- ============================================================
-- Update Guest Confirmation Email Template
-- Date: 2026-05-24
-- Description: Updates the guest_confirmation email template
--   to reflect the new email verification flow (code entered on
--   website) instead of the old bartender verification flow.
-- ============================================================
